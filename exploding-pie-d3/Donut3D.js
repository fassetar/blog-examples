! function() {
  ...
  function explode() {
    ...
    return "translate(" + (midpoint.x/2)  + "," + (midpoint.y/2) + ")";
  }
  ...
  Donut3D.draw = function(id, data, x /*center x*/ , y /*center y*/ ,
    ...
    slices.selectAll(".topSlice")
      ...
      .attr("d", arc).attr("class", "topSlice")
      .attr("id", "topMove")
      .style("fill", function(d) {
        return d.data.color;
      })
      ...
      .on("click", function(d, index) {
        var active = topMove.active ? false : true;
        if (active) {
          d3.select(this).transition().duration(750).ease('bounce', d)
            .attr("transform", explode);
        } else {
          d3.select(this).transition().duration(750).ease('bounce', d)
            .attr("transform", 'translate(0,0)');
        }
        topMove.active = active;
      });
